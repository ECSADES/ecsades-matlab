...
% - Annual rate-of-occurence using local Possion max-likelihood estimate
...
% - Gamma fitted below the threshold
...
%
NEP=[0.8,0.9];  %GP non exceedence probability range
...
CV.SmthLB=-12;   %lower bound (log10)  for smmothness range
CV.SmthUB=8;   %upper bound (log10)  for smmothness range
